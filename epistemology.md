...
| `parity_corr_eq_one` | `propext`, `Classical.choice`, `Quot.sound` (standard) |
| `pairwise_blind_to_parity` | `propext`, `Classical.choice`, `Quot.sound` (standard) |
| `third_sees_parity` | `propext`, `Classical.choice`, `Quot.sound` (standard) |
| `third_reading_positive` | `propext`, `Classical.choice`, `Quot.sound` (standard) |
| `rent_holds` | `propext`, `Classical.choice`, `Quot.sound` (standard) |
| `underpaid_shrinks` | `propext`, `Classical.choice`, `Quot.sound` (standard) |
| `unpaid_succ` | `propext`, `Classical.choice`, `Quot.sound` (standard) |
| `unpaid_decays` | `propext`, `Classical.choice`, `Quot.sound` (standard) |
