...
def landingPage : String :=
  ...
  shell "CIRISOntology — computational philosophy informing AI safety research" "Overview"
    ...
    ++ "agent programme. Its newest layer is a grammar pair over the kinds - an armored trust "
    ++ "grammar and its raw lab counterpart - built so every safety protection is a derivable "
    ++ "difference rather than a promise. Beneath it, the lake&rsquo;s longer research question: <i>where can "
