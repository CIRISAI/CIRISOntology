...
, { key      := "third-in-tsvf"
  ...
  , plain    :=
      ...
      ++ "colleagues, Zhou's quantum form); the recognition of putting it on the "
      ++ "multi-time object is, after two literature passes, still not found in "
      ++ "print.\n\n"
  ...
  , kill     :=
      ...
      ++ "published pairwise-blind share on a multi-time object predating ours. That "
      ++ "kills the recognition sentence and nothing else — the theorems do not care "
      ++ "who was first."
  , confidence :=
      ...
      ++ "our knowledge, the first machine-checked one. The share framing survived "
      ++ "kill-checks on 2026-07-24 and 2026-07-25; a non-arXiv venue could still "
      ++ "fire it, and would be reported the day it is found."
