...
, { key      := "law-as-habit"
  ...
  , plain    :=
      ...
      ++ "maintenance accounting fails. (The odd one out, the strong-CP angle, is "
      ++ "tiny without visible protection — which is exactly why physicists proposed "
      ++ "the axion: a guardian, still unfound.)\n\n"
