...
, { key      := "gravity-charge"
  ...
  , plain    :=
      ...
      ++ "survives — and is among the best-tested facts in physics — is about the "
      ++ "coupling: how a thing SOURCES gravity, and how it falls.\n\n"
      ++ "Gravity couples to stress-energy and to nothing else about a system. Two bodies "
      ++ "with the same mass-energy couple and fall identically whether they are lead or "
      ++ "water, book or rubble, truth or lies. There is no gravitational charge for "
      ++ "composition, arrangement, or meaning. Torsion-free gravity reads exactly one "
      ++ "column of any system's books.\n\n"
      ++ "So the honest form of the old headline is narrower: at the point of coupling, "
      ++ "gravity prices how much — never what kind, and never what it means. The "
      ++ "meaning-sector still goes unpriced at the source, even though waves can carry a "
      ++ "source's shape away with them.\n\n"
      ++ "How sure are we? Measured — this is the weak equivalence principle, tested to "
      ++ "parts in a hundred trillion."
  , status   := .measured
  , kill     :=
