...
, { key      := "dark-balance-extensive"
  ...
  , plain    :=
      ...
      ++ "is a live tension, not a settled verdict. This reading still owes its extra "
      ++ "machinery — a reason the grand total acts only on the smooth whole and never in "
      ++ "lumps — or the void measurements will decide it.\n\n"
      ++ "One dated experiment decides between this reading and the one before it: DESI DR3 is "
      ++ "a single test, the two point opposite ways on it, and at most one survives — a "
      ++ "middling result could take both.\n\n"
