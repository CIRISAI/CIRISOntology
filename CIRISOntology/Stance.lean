...
, { key      := "precedent-is-bits"
  ...
  , confidence :=
      "A wager composed of wagers, marked accordingly. Ancestors named: Peirce, Smolin "
      ++ "(precedence), Gough (holographic dark information energy), Verlinde and the "
      ++ "holographic school. The machine-checked part is only this: habit requires "
      ++ "carried classical bits, and carrying costs. Everything cosmological is the "
      ++ "composition, not the theorem."
  , promote  :=
      "Derive the record's growth law from the rent clause — the e-upkeep bookkeeping — "
      ++ "and match the dark-energy equation of state against star-formation history IN "
      ++ "ADVANCE of the next data release; or run a precedence-class protocol with "
      ++ "pre-registered lawfulness-onset curves. Either would move one leg from story to "
      ++ "measurement."
  }
