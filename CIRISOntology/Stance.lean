...
, { key      := "s8-fingerprint"
  ...
  , plain    :=
      "Here is a real, mild puzzle in the data. Take the baby-picture of the universe (the cosmic "
      ++ "microwave background) and use it to predict how clumpy the universe should be today. Then "
      ++ "measure today's clumpiness directly, with gravitational lensing. The measured clumpiness "
