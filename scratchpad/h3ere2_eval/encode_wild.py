...
def main(model_path, tok_dir=None, out_name="encoded.jsonl"):
    tok=AutoTokenizer.from_pretrained(tok_dir or f"{NL}/ft_merged")
...
if __name__=="__main__": main(sys.argv[1], sys.argv[2] if len(sys.argv)>2 else None, sys.argv[3] if len(sys.argv)>3 else "encoded.jsonl")
